...
class RawMerkleBlockMessageSerializerTest extends BitcoinSUnitTest {
  ...
  "RawMerkleBlockMessage" must "read a raw hex string into a merkle block message" in {
    ...
    merkleBlockMessage.merkleBlock.hashes must be(
      Seq(
        DoubleSha256Digest(BytesUtil.decodeHex("3612262624047ee87660be1a707519a443b1c1ce3d248cbfc6c15870f6c5daa2")),
        DoubleSha256Digest(BytesUtil.decodeHex("019f5b01d4195ecbc9398fbf3c3b1fa9bb3183301d7a1fb3bd174fcfa40a2b65")),
        DoubleSha256Digest(BytesUtil.decodeHex("41ed70551dd7e841883ab8f0b16bf04176b7d1480e4f0af9f3d4c3595768d068")),
        DoubleSha256Digest(BytesUtil.decodeHex("20d2a7bc994987302e5b1ac80fc425fe25f8b63169ea78e68fbaaefa59379bbf"))
      ))

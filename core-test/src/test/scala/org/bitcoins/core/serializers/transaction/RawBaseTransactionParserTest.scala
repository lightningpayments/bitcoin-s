...
import org.bitcoins.core.protocol.transaction.{BaseTransaction, Transaction, TransactionConstants}
...
class RawBaseTransactionParserTest extends BitcoinSUnitTest {
  ...
  "RawBaseTransactionParser" must "parse a raw transaction" in {
    ...
    tx.txId.hex must be(BytesUtil.flipEndianness("44e504f5b7649d215be05ad9f09026dee95201244a3b218013c504a6a49a26ff"))
  }
  ...
  it must "parse a transaction correctly with a locktime" in {
    ...
    tx.txId.hex must be(BytesUtil.flipEndianness("bdc221db675c06dbee2ae75d33e31cad4e2555efea10c337ff32c8cdf97f8e74"))

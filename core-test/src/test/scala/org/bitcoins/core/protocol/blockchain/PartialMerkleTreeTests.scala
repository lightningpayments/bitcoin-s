...
class PartialMerkleTreeTests extends BitcoinSUnitTest {
  "PartialMerkleTree" must "from a list of txs and a bit indicating if the tx matched the filter" in {
    ...
    val hash1 =
      DoubleSha256Digest(BytesUtil.flipEndianness("74d681e0e03bafa802c8aa084379aa98d9fcd632ddc2ed9782b586ec87451f20"))
    val hash2 =
      DoubleSha256Digest(BytesUtil.flipEndianness("dd1fd2a6fc16404faf339881a90adbde7f4f728691ac62e8f168809cdfae1053"))
    ...
    partialMerkleTree.bits
      ...
      .toIndexedSeq must be(Seq(true, true, true, true, false, false, false, false))
  ...
  it must "build a partial merkle tree with 1 match and 2 transactions inside the original block" in {
    ...
    partialMerkleTree.extractMatches must be(
      Seq(DoubleSha256Digest("076d0317ee70ee36cf396a9871ab3bf6f8e6d538d7f8a9062437dcb71c75fcf9")))
  }
  ...
  it must "correctly compute a merkle tree that has an odd amount of txids on the merkle tree" in {
    ...
    val bits = BitVector.bits(
      List(true, true, true, true, true, true, true, false, true, true, false, true, true, true, false, true, true,
        true, true, false, true, true, true, true, true, true, true, false, true, true, true, true, false, true, true,
        true, true, false, false, false))
    val tree = PartialMerkleTree(numTransactions, hashes, bits)
    tree.extractMatches.contains(
      DoubleSha256Digest("5df6e0e2761359d30a8275058e299fcc0381534545f55cf43e41983f5d4c9456")) must be(true)
  }

...
case class DLCAccountingDbs(dlcDb: DLCDb, offerDb: DLCOfferDb, acceptDb: DLCAcceptDb, closingTx: Transaction) {
  require(dlcDb.dlcId == offerDb.dlcId,
          s"dlcDb.dlcId not equal to offerDb.dlcId, got dlcDb.dlcId=${dlcDb.dlcId} offerDb.dlcId=${offerDb.dlcId}")
  require(offerDb.dlcId == acceptDb.dlcId,

...
trait MempoolRpc { self: Client =>
  ...
  def getMemPoolAncestors(txid: DoubleSha256DigestBE): Future[Vector[DoubleSha256DigestBE]] = {
    bitcoindCall[Vector[DoubleSha256DigestBE]]("getmempoolancestors", List(JsString(txid.hex), JsBoolean(false)))
  }
  ...
  def getMemPoolAncestorsVerbose(txid: DoubleSha256DigestBE): Future[Map[DoubleSha256DigestBE, GetMemPoolResult]] = {
    ...
    self.version.flatMap {
      case V21 | V20 | V19 | Experimental | Unknown =>
        bitcoindCall[Map[DoubleSha256DigestBE, GetMemPoolResultPostV19]]("getmempoolancestors",
                                                                         List(JsString(txid.hex), JsBoolean(true)))
      case V16 | V17 | V18 =>
        bitcoindCall[Map[DoubleSha256DigestBE, GetMemPoolResultPreV19]]("getmempoolancestors",
                                                                        List(JsString(txid.hex), JsBoolean(true)))
    }
  }
  ...
  def getMemPoolDescendants(txid: DoubleSha256DigestBE): Future[Vector[DoubleSha256DigestBE]] = {
    bitcoindCall[Vector[DoubleSha256DigestBE]]("getmempooldescendants", List(JsString(txid.hex), JsBoolean(false)))
  }
  ...
  def getMemPoolDescendantsVerbose(txid: DoubleSha256DigestBE): Future[Map[DoubleSha256DigestBE, GetMemPoolResult]] = {
    self.version.flatMap {
      case V21 | V20 | V19 | Experimental | Unknown =>
        bitcoindCall[Map[DoubleSha256DigestBE, GetMemPoolResultPostV19]]("getmempooldescendants",
                                                                         List(JsString(txid.hex), JsBoolean(true)))
      case V16 | V17 | V18 =>
        bitcoindCall[Map[DoubleSha256DigestBE, GetMemPoolResultPreV19]]("getmempooldescendants",
                                                                        List(JsString(txid.hex), JsBoolean(true)))
    }
  }
  ...
  def getMemPoolEntry(txid: DoubleSha256DigestBE): Future[GetMemPoolEntryResult] = {
    ...
    self.version.flatMap {
      case V21 | V20 | V19 | Experimental | Unknown =>
        bitcoindCall[GetMemPoolEntryResultPostV19]("getmempoolentry", List(JsString(txid.hex)))
      case V16 | V17 | V18 =>
        bitcoindCall[GetMemPoolEntryResultPreV19]("getmempoolentry", List(JsString(txid.hex)))
    }
  ...
  def getRawMemPool: Future[Vector[DoubleSha256DigestBE]] = {
    bitcoindCall[Vector[DoubleSha256DigestBE]]("getrawmempool", List(JsBoolean(false)))
  }
  ...
  def getRawMemPoolWithTransactions: Future[Map[DoubleSha256DigestBE, GetMemPoolResult]] = {
    ...
    self.version.flatMap {
      case V21 | V20 | V19 | Experimental | Unknown =>
        bitcoindCall[Map[DoubleSha256DigestBE, GetMemPoolResultPostV19]]("getrawmempool", List(JsBoolean(true)))
      case V16 | V17 | V18 =>
        bitcoindCall[Map[DoubleSha256DigestBE, GetMemPoolResultPreV19]]("getrawmempool", List(JsBoolean(true)))
    }

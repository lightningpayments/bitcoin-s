...
import org.bitcoins.commons.jsonmodels.bitcoind.{GetBlockTemplateResult, GetMiningInfoResult, RpcOpts}
...
trait MiningRpc { self: Client =>
  ...
  def generateToAddress(
    ...
    bitcoindCall[Vector[DoubleSha256DigestBE]]("generatetoaddress",

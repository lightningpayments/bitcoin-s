...
object SchnorrSigPointTestVectorGen extends TestVectorGen[SchnorrSigPointTestVector, SchnorrSigPointTestVectorInput] {
  ...
  override def inputFromJson: JsValue => JsResult[SchnorrSigPointTestVectorInput] =
    SchnorrSigPointTestVectorInput.fromJson

  override val inputStr: String = "inputs"

  override def generateFromInput: SchnorrSigPointTestVectorInput => Future[SchnorrSigPointTestVector] = { inputs =>
    Future.successful(SchnorrSigPointTestVector(inputs))
  }

  override def generateTestVectors(): Future[Vector[SchnorrSigPointTestVector]] = {

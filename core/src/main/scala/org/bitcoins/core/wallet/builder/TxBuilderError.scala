...
object TxBuilderError {
  ...
  val FailedUserInvariants = Failure(
    new IllegalArgumentException("This tx fails the invariants function you passed in"))
  ...
  val TooManySigners = Failure(
    new IllegalArgumentException("You passed in too many signers for this scriptPubKey type"))
  ...
  val WrongWitness = Failure(
    new IllegalArgumentException("You passed in the wrong ScriptWitness type to sign the given WitnessScriptPubKey"))
  ...
  val WrongPublicKey = Failure(
    new IllegalArgumentException("You passed in the wrong public key to sign a P2PKHScriptPubKey"))
  ...
  val MissingDestinationOutput = Failure(
    new IllegalArgumentException("Lost a transaction output in the finalizing process"))
  ...
  val MissingPublicKey = Failure(
    new IllegalArgumentException("You did not pass in a public key to sign a P2PKHScriptPubKey with"))
  ...
  val ExtraOutputsAdded = Failure(
    new IllegalArgumentException("More outputs were added to the transaction than were initally passed in"))
  ...
  val MintsMoney = Failure(
    new IllegalArgumentException("This transaction creates spends more money than it was funded by the given utxos"))

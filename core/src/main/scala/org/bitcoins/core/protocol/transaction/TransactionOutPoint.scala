...
import org.bitcoins.crypto.{DoubleSha256Digest, DoubleSha256DigestBE, Factory, NetworkElement}
...
/** @param txId The transaction id for the crediting transaction for this input
  ...
  */
case class TransactionOutPoint(txId: DoubleSha256Digest, vout: UInt32) extends NetworkElement {
...
/** UInt32s cannot hold negative numbers, but sometimes the Bitcoin Protocol
  ...
  */
final object EmptyTransactionOutPoint extends TransactionOutPoint(txId = DoubleSha256Digest.empty, vout = UInt32.max) {

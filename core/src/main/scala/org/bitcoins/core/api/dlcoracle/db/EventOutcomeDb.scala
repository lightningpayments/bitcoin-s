...
case class EventOutcomeDb(nonce: SchnorrNonce, message: String, hashedMessage: ByteVector)

object EventOutcomeDbHelper {

  def createEnumEventDescriptor(outcomes: Vector[EventOutcomeDb]): EnumEventDescriptorV0TLV = {
